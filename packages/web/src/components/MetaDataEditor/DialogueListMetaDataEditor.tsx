import { type IDialogueItem, type TStateDialogueList, dialogueListAtom } from "@/stateV2/dialogueList";
...
const DialogueListMetaDataEditor = () => {
  ...
  return (
    <Form form={form} layout="vertical" onFinish={onFinish} autoComplete="off">
      ...
      <Form.Item<IDialogueItem> name="lastMessage" label="最后一条消息" rules={[{ required: true }]}>
        <Input />
      </Form.Item>
      <Form.Item<IDialogueItem> name="lastMessageTime" label="最后一条消息发送时间" rules={[{ required: true }]}>
        <Input
          suffix={
            <>
              <Button
