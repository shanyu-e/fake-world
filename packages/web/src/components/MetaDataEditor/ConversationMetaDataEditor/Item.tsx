import { ConversationTypeLabel, EConversationType, type TConversationItem, conversationListAtom } from "@/stateV2/conversation";
...
const ConversationItemMetaDataEditor = ({ data, index }: EditorProps<TConversationItem, [IStateProfile["id"], TConversationItem["id"]]>) => {
