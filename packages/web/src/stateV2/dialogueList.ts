...
export const dialogueListAtomConfig = createDataSourceAtom<TStateDialogueList>(
  "dialogues",
  [
    {
      id: "1",
...
export const dialogueListAtom = dialogueListAtomConfig.atom;
export const dialogueListLoadingAtom = dialogueListAtomConfig.loadingAtom;
export const dialogueListErrorAtom = dialogueListAtomConfig.errorAtom;
export const dialogueListLoadAtom = dialogueListAtomConfig.loadAtom;
export const dialogueListCreateAtom = dialogueListAtomConfig.createAtom;
export const dialogueListDeleteAtom = dialogueListAtomConfig.deleteAtom;
...
export const dialogueListEffect = atomEffect((get, set) => {
  ...
  if (calcuateType === "auto") {
    const count = dialogueList.reduce((acc, dialogue) => {
      if (!dialogue.badgeHide && dialogue.unreadDisplayType !== "dot" && typeof dialogue.unreadMarkNumber === "number") {
